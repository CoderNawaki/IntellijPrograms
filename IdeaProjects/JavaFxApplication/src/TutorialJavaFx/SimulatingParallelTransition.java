...
public class SimulatingParallelTransition extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        rotateline3.setByAngle(360);
        rotateline3.setAutoReverse(true);
        rotateline3.setDuration(Duration.millis(1000));
        rotateline3.setCycleCount(100);
        ...
        rotateline4.setByAngle(360);
        rotateline4.setCycleCount(100);
        rotateline4.setDuration(Duration.millis(1000));
        ...
        fadeCir1.setCycleCount(100);
        fadeCir1.setDuration(Duration.millis(1000));
        ...
        fadeCir2.setDuration(Duration.millis(1000));
        fadeCir2.setCycleCount(100);
        ...
        fadeCir3.setCycleCount(100);
        fadeCir3.setDuration(Duration.millis(1000));
        ...
        fadeCir4.setCycleCount(100);
        fadeCir4.setDuration(Duration.millis(1000));
        ...
        root.getChildren().addAll(cir1,cir2,cir3,cir4,line1,line2,line3,line4);

        Scene scene = new Scene(root,600,550,Color.WHITESMOKE);
